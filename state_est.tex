...
The standard Rauch-Tung-Striebel (RTS) smoother gives the statistics $\v{m}_{k|N}$ and $\v{P}_{k|N}$ \parencite{jazwinski2007stochastic,Rauch1965}.
...
\begin{align}
	...
	\v{C}_{k|N}&=\v{P}_{k|k}\v{J}_{k-1}^T+\v{J}_k\left(\v{C}_{k+1|N}-\v{A}\v{P}_{k|k}\right)\v{J}_{k-1}^T \label{eq:rts_cross_timestep_covariance}
\end{align}
\end{subequations}
