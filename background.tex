...
sequential data \parencite{Cappe2005,durbin2012time,barber2011bayesian}. Sequential data arise in numerous applications, typically in the form
...
variables is a \emph{Bayes network} presented by directed acyclic graph (DAG) \parencite{pearl1988probabilistic,Bishop2006a}.
