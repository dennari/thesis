...
The gradient based methods provide faster convergence and no need to
solve the M-step maximization expressions. EM on the other hand
provides a less laborious way of computing the gradient.
...
and then use gradient based methods. Another possibility is to use gradient based
