...
%&=\Tr{\v{R}^{-1}\left(\mathrm{Var}\left(\v{y}_k-\v{H}\v{x}_{k}\right)+\left(\v{y}_k-\v{H}\v{m}_{k|N}\right)\left(\v{y}_k-\v{H}\v{m}_{k|N}\right)^T\right)}\\
%&=\Tr{\v{R}^{-1}\left(\v{y}_k\v{y}_k^T-\v{y}_k\v{m}_{k|N}^T\v{H}^T-\v{H}\v{m}_{k|N}\v{y}_k^T+\v{H}\left(\v{P}_{k|N}+\v{m}_{k|N}\v{m}_{k|N}^T\right)\v{H}^T\right)}\\
\end{split}
\end{align}
With these, we have
\begin{multline}
