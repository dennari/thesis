...
\end{split}
\end{align}
Here the matrices of all the states and all the observations are denoted with\todo{notation changes}
\begin{align}
	\v{X}&=\v{X}_{1:N}=
	\begin{bmatrix}
		\v{x}_1 & \dots & \v{x}_N
...
$\Pdf{\v{Y}}{\gv{\theta}}$ (or equivalently its logarithm) \todo{elaborate}. Going further
...
\begin{align}
	\Pdf{\v{Y}}{\gv{\theta}}&=\defint{\R^{d_x}}{}{\Pdf{\v{X},\v{Y}}{\gv{\theta}}}{\v{X}}
...
\parencite{Harvey1990,Watson1983,Cappe2005,Saatci2011}
