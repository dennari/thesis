...
\end{align}
i.e the set of points that maximize the Q function in the M-step. Let us also denote by
\begin{align}
	\brac*{\Th_j} = \brac[\big]{\Th_{j+1} : \Th_{j+1}\in\EMM{\Th_{j}} },
\end{align}
the sequence generated by $\EMM$.
