...
Let us take a closer at the the first term in \eqref{eq:lLH_decomp} with $\tPX=\post{\Th'}$:
\begin{align}
	\LB{\post{\Th'}}{\Th}&=
	\underbrace{\E{\log\cLH}_{\Pdf[p][1pt]{\X}{\Y,\Th'}}}_{\Lb[1pt]{\Th'}{\Th}} 
	-\E{\log\post{\Th'}}_{\post[1pt]{\Th'}}.
...
\begin{align}
		...
		\left.\dpd{ \Lb{\widehat\Th}{\Th}}{\theta_i}\right|_{\Th=\widehat\Th} \label{eq:EM_gradients}
\end{align} 
