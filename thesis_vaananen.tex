...
\NewDocumentCommand\post{G{\Th}}{\Pdf{\X}{\Y,#2}}
\NewDocumentCommand\cLH{}{\Pdf{\X,\Y}{\Th}}
%\NewDocumentCommand\lcLH{O{0pt}}{\log\cLH[#1]}
\NewDocumentCommand\LB{G{\tP} G{\Th}}{\F{\mathcal L}{#2,#3}}
\NewDocumentCommand\Lb{G{\Th'} G{\Th}}{\F{\mathfrak L}{#2,#3}}
