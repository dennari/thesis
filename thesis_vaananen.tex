...
\NewDocumentCommand\post{G{\Th}}{\Pdf[p][\normalsize]{\X}{\Y,#1}}
\NewDocumentCommand\cLH{G{\Th}}{\Pdf{\X,\Y}{#1}}
\NewDocumentCommand\LH{G{\Th}}{\Pdf{\Y}{#1}}
%\NewDocumentCommand\lcLH{O{0pt}}{\log\cLH[#1]}
\NewDocumentCommand\EMQ{G{\Th'} G{\Th}}{\F[\normalsize]{\mathcal Q}{#2,#1}}
\NewDocumentCommand\EMH{G{\Th'} G{\Th}}{\F[\normalsize]{\mathcal H}{#2,#1}}
\NewDocumentCommand\EMB{G{\Th'} G{\Th}}{\F[\normalsize]{\mathcal B}{#2,#1}}
\NewDocumentCommand\EMM{O{} G{\Th}}{\F[\normalsize]{\v{M}#1}{#2}}
