...
\begin{figure}[htb]%
    ...
    \begin{subfigure}[t]{0.5\textwidth}%
    	...
    	\caption{A simulation of the AR(1) model with $a=1$.
    ...
    \begin{subfigure}[t]{0.5\textwidth}%
    	...
    	\caption{A plot of the unnormalized probability distribution of $a$, given the simulated measurements and with a uniform prior.}%
		\label{fig:ar1_lh}%
    \end{subfigure}%
